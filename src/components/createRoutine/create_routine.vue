  ...
  <div>
      ...
      <div class="px-14 mt-8">
        ...
        <div v-for="index in extraSections" :key="index">
          <routine_panel :title="sectionName(index+1)" :isDeletable="true" :isModifiable="true" :id_routine="id" :order="index + 3"></routine_panel>
        </div>

        <routine_panel title="Enfriamiento" :id_routine="id" :order="extraSections"></routine_panel>
